...
public class Copier {
	...
	//to the main queue.
	private /*@ spec_public @*/Basket basket;
	
	//The path of the file being copied
	private /*@ spec_public @*/ String currentFileSource;
	
	//The path of the destination file
	private /*@ spec_public @*/String currentFileDestination;
	...
	private /*@ spec_public @*/ TransferTask copyOp;
	
	//Transfer sizes sum
	private /*@ spec_public @*/long queueTotalSize;
	
	//Bytes already copied
	private/*@ spec_public @*/ long queueCurrentSize;
	
	//Current treated file total size
	private/*@ spec_public @*/ long fileTotalSize;
	
	//Bytes already copied for current file
	private/*@ spec_public @*/ long fileCurrentSize;
	
	//GUI of the copier
	private /*@ spec_public @*/MainFrame gui;
	
	private /*@ spec_public @*/long bytesCounter;
	...
	/*@
	 @ requires path !=null;  
	 @ ensures this.basket.getLength() !=0;
	 @*/
	...
	/*@
	  @ ensures this.currentFileSource == \old(this.currentFileSource);
	  @*/
	...
	/*@
	  @ ensures this.currentFileDestination == \old(this.currentFileDestination);
	  @*/
	...
	/*@
	  @ requires sourcePath !=null;  
	  @ requires destPath !=null; 
	  @ assignable this.currentFileSource,this.currentFileDestination ;
	  @ ensures this.currentFileSource == sourcePath;
	  @ ensures this.currentFileDestination == destPath;
	  @*/
	...
	/*@
	  @ ensures this.paused == \old(this.paused);
	  @*/
	...
	/*@
	  @ ensures this.busy == \old(this.busy);
	  @*/
	...
	/*@
	  @ requires file !=null;  
	  @ ensures this.mainQueue.maninQueueSize() != 0;
	  @*/
	...
	/*@
	  ...
	  @*/
	public void increaseQueueTotalSize(long number) {
		this.queueTotalSize += number;
		gui.totalSizeSignal();
	}
	...
	/*@
	  ...
	  @ ensures this.queueTotalSize <= number ;
	  @*/
	public void decreaseQueueTotalSize(long number){
		this.queueTotalSize -= number;
		gui.totalSizeSignal();
	}
	...
	/*@
	  ...
	  @ ensures this.bytesCounter >= number ;
	  @*/
	public void increaseQueueCurrentSize(long number) {
		this.queueCurrentSize += number;
		//For speed measures
		this.bytesCounter += number;
	}
	...
	/*@
	  ...
	  @ ensures this.queueCurrentSize <= number ;
	  @*/
	public void decreaseQueueCurrentSize(long number){
		this.queueCurrentSize -= number;
	}
	
	/*@
	  @ requires size>0.0 ;  
	  @ ensures this.fileCurrentSize == size ;
	  @*/
	public void setFileCurrentSize(long size){
		this.fileCurrentSize = size;
	}
	
	/*@
	  @ requires nb>0.0 ;  
	  @ ensures this.fileCurrentSize >= nb ;
	  @*/
	...
	/*@ 
	  @ requires this.queueTotalSize >= 0.0 ;  
	  @ requires this.queueCurrentSize >=0.0 ;
	  @ ensures \result >=0;
	  @*/
	...
	/*@ 
	  @ ensures \result >=0;
	  @*/
	public /*@ pure @*/ long getQueueTotalSize() {
