...
public class TransferTask extends Thread{
	...
	private /*@ spec_public @*/ Copier copier;
	
	private /*@ spec_public @*/ File source;
	
	private /*@ spec_public @*/ File destination;
	
	private /*@ spec_public @*/ File destinationFolder;
	
	private /*@ spec_public @*/ Boolean append;
	
	private /*@ spec_public @*/ Boolean paused;
	
	private /*@ spec_public @*/ Boolean cancel;
	
	private /*@ spec_public @*/ long totalSize;
	
	private /*@ spec_public @*/ long currentSize;
	...
	/*@
	 @ requires c != null;  
	 @ requires file !=null;
	 @ ensures this.copier != null;  
	 @ ensures this.destination != null;  
	 @ ensures this.append != null;  
	 @ ensures this.paused != null;  
	 @ ensures this.cancel != null;
	 @ ensures this.totalSize >= 0;
	 @*/
