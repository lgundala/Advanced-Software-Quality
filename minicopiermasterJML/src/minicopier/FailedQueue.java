...
private /*@ spec_public @*/ Copier copier;
	...
	private /*@ spec_public @*/ Vector<FileToTransfer> failedItems;
	private /*@ spec_public @*/ DefaultTableModel tableModel;

	/*@
	 @ requires c !=null;  
	 @ ensures this.failedItems != null;
	 @ ensures this.tableModel != null;
	 @*/
	...
	/*@
	 @ requires this.tableModel !=null;  
	 @ ensures \result == this.tableModel ;
	 @*/
	...
	/*@
	 @ requires file !=null;  
	 @ ensures this.tableModel.getRowCount() >= 0 ;
	 @*/
